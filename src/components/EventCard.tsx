            ...
            <section className="relative w-full bg-[#FAF5F1] py-24">
                ...
                <div className="relative max-w-6xl mx-auto px-6 md:px-16">
                    <div className="border border-[#2c5836] py-10 px-6 md:px-12 flex flex-col items-center text-center relative overflow-hidden">
                        ...
                        <p className="font-sans-light max-w-3xl mx-auto text-stone-800 leading-relaxed text-lg md:text-xl pt-6 underline underline-offset-5 decoration-1">
                            <a
                ...
                <div className="absolute right-[-5] top-5 md:right-45 md:top-[-30] pointer-events-none w-[120px] h-[168px] md:w-[220px] md:h-[320px]">
                    <Image
